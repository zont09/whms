...
class UserRepository {
  ...
  // Future<void> updateWorkShift(WorkShiftModel work) async {
...
// import 'package:cloud_firestore/cloud_firestore.dart';
// import 'package:daily/app_text.dart';
// import 'package:daily/features/home/model/work_shift_model.dart';
// import 'package:daily/models/response_model.dart';
// import 'package:daily/models/user_model.dart';
// import 'package:daily/services/user_service.dart';
// import 'package:firebase_auth/firebase_auth.dart';
// import 'package:firebase_core/firebase_core.dart';
// import 'package:firebase_storage/firebase_storage.dart';
// import 'package:flutter/material.dart';
...
//   //         apiKey: "AIzaSyDkRE97qNhv4tWcR_ABxIztvyS3PTwBCZU",
//   //         authDomain: "pls-daily.firebaseapp.com",
//   //         databaseURL: "https://pls-daily-default-rtdb.firebaseio.com",
//   //         projectId: "pls-daily",
//   //         storageBucket: "pls-daily.firebasestorage.app",
//   //         messagingSenderId: "822005324889",
//   //         appId: "1:822005324889:web:f5d22be439843a316ba548",
//   //         measurementId: "G-GV97XNH65E"
//   //     ),
//   //   );
//   // FirebaseApp secondaryApp;
//   // FirebaseStorage get storage => FirebaseStorage.instance;
//   FirebaseApp secondaryApp = GetIt.instance<FirebaseApp>();
//
//   // Truy cập Firestore từ secondary app
...
//         password: password,
//       );
//       // final account = await UserServices.instance.getAccountByEmail(email);
//       // if (account == null) {
//       //   return ResponseModel(
//       //     status: ResponseStatus.error,
//       //     error: ErrorModel(
...
//       //   );
//       // }
//       final temp = await UserServices.instance.getAllUserIgnoreEnable();
//       print('=========> tmp ${temp.length}');
//
//       final user = await UserServices.instance.getUserByEmail(email);
...
//   }
//
//   Future<QuerySnapshot<Map<String, dynamic>>> getWorkShiftById(String id) async {
//
//     final snapshot =
//     await db.collection("daily_pls_work_shift").where("id", isEqualTo: id).get();
//     return snapshot;
//   }
//
//   Future<void> createWorkShift(WorkShiftModel work) async {
