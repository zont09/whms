      ...
      children: [
        InkWell(
            ...
            child: Row(children: [
              ...
              const ZSpace(w: 4),
              Image.asset('assets/images/icons/tab_bar/ic_tab_meeting.png',
                  height: ScaleUtils.scaleSize(20, context),
                  color: ColorConfig.primary3),
              const ZSpace(w: 4),
              Expanded(
                  child: Text(AppText.titleMeetingDetails.text,
                      style: TextStyle(
        ...
        Row(
          children: [
            InkWell(
                ...
                child: Container(
                    ...
                    child: Row(children: [
                      ...
                      const ZSpace(w: 4),
                      Text(getTime(cubit.meeting.time),
                          style: TextStyle(
                      ...
                      Text("|",
                          style: TextStyle(
                              ...
                              letterSpacing: -0.02)),
                      const ZSpace(w: 5),
                      Text(getDate(cubit.meeting.time),
                          style: TextStyle(
                              fontSize: ScaleUtils.scaleSize(12, context),
            ...
            DropdownStatusMeeting(
                ...
                options:
                    StatusMeetingDefine.values.map((e) => e.title).toList())
          ],
        ),
      ],
    );
